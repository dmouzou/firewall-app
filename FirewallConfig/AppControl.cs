...
namespace _3M_Firewall.FirewallConfig
{
    public class AppControl
    {
        ...
        public void Setup(RuleModel ruleModel, AppModel appModel)
        {
            ...
            string text = appModel.AppPathName;
            newRule.Description = string.Concat("The Firewall is blocking the app with the path: ", text);

            newRule.ApplicationName = appModel.AppPathName.ToString();
